...
class ManualCar:public car{
    ...
    void accelerate(int speed)
    {
        if(isEngineion == false){
            ...
            currentspeed = currentspeed+speed;//the manual car is supposed to have a good speed
            cout<<"The speed of the car after the accelertaion becomes "<<currentspeed<<endl;
        }
    }
    void brake()
...
int main()
{
    ...
    mymanualcar->accelerate(); //hence both can be working 
    //mymanualcar->accelerate(45);
    mymanualcar->brake();
